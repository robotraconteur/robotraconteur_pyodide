...
namespace RobotRaconteur
{
	...
	namespace detail
	{
		...
		protected:
			...
			virtual void AsyncAttachStream(bool server, const NodeID& target_nodeid, const boost::string_ref, boost::function<void(RR_SHARED_PTR<RobotRaconteurException>)>& callback);
		public:
