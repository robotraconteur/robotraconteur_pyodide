...
namespace RobotRaconteur
{
	...
	ServiceStub::ServiceStub(boost::string_ref path, RR_SHARED_PTR<ClientContext> c)
	{
		...
		ROBOTRACONTEUR_LOG_TRACE_COMPONENT_PATH(node, Client, RREndpoint, ServicePath,	"", "ServiceStub created with type: " << RRType());
	}
	...
	void ServiceStub::AsyncFindObjRef(boost::string_ref n, RR_MOVE_ARG(boost::function<void(RR_SHARED_PTR<RRObject>, RR_SHARED_PTR<RobotRaconteurException>)>) handler, int32_t timeout)
	{
		GetContext()->AsyncFindObjRef(ServicePath + "." + n, "", RR_MOVE(handler), timeout);
	}

	void ServiceStub::AsyncFindObjRef(boost::string_ref n, boost::string_ref i, RR_MOVE_ARG(boost::function<void(RR_SHARED_PTR<RRObject>, RR_SHARED_PTR<RobotRaconteurException>)>) handler, int32_t timeout)
	{
		GetContext()->AsyncFindObjRef(ServicePath + "." + n + "[" + detail::encode_index(i) + "]", "", RR_MOVE(handler), timeout);
	}

	void ServiceStub::AsyncFindObjRefTyped(boost::string_ref n, boost::string_ref objecttype, RR_MOVE_ARG(boost::function<void(RR_SHARED_PTR<RRObject>, RR_SHARED_PTR<RobotRaconteurException>)>) handler, int32_t timeout)
	{
		GetContext()->AsyncFindObjRef(ServicePath + "." + n, objecttype, RR_MOVE(handler), timeout);
	}

	void ServiceStub::AsyncFindObjRefTyped(boost::string_ref n, boost::string_ref i, boost::string_ref objecttype, RR_MOVE_ARG(boost::function<void(RR_SHARED_PTR<RRObject>, RR_SHARED_PTR<RobotRaconteurException>)>) handler, int32_t timeout)
	{
		GetContext()->AsyncFindObjRef(ServicePath + "." + n + "[" + detail::encode_index(i) + "]", objecttype, RR_MOVE(handler), timeout);
	}

	void ServiceStub::AsyncFindObjectType(boost::string_ref n, RR_MOVE_ARG(boost::function<void(RR_SHARED_PTR<std::string>, RR_SHARED_PTR<RobotRaconteurException>)>) handler, int32_t timeout)
	{
		GetContext()->AsyncFindObjectType(ServicePath + "." + n, RR_MOVE(handler), timeout);
	}

	void ServiceStub::AsyncFindObjectType(boost::string_ref n, boost::string_ref i, RR_MOVE_ARG(boost::function<void(RR_SHARED_PTR<std::string>, RR_SHARED_PTR<RobotRaconteurException>)>) handler, int32_t timeout)
	{
	...
	{
		ROBOTRACONTEUR_LOG_TRACE_COMPONENT_PATH(node, Client, RREndpoint, ServicePath, m->MemberName, "Pipe packet received for nonexistant member");
	}

	void ServiceStub::DispatchWireMessage(RR_INTRUSIVE_PTR<MessageEntry> m)
	{
		ROBOTRACONTEUR_LOG_TRACE_COMPONENT_PATH(node, Client, RREndpoint, ServicePath, m->MemberName, "Wire packet received for nonexistant member");
	}

	RR_INTRUSIVE_PTR<MessageEntry> ServiceStub::CallbackCall(RR_INTRUSIVE_PTR<MessageEntry> m)
	{
		ROBOTRACONTEUR_LOG_TRACE_COMPONENT_PATH(node, Client, RREndpoint, ServicePath, m->MemberName, "Callback request received for nonexistant member");
	...
	void ClientContext::AsyncFindObjRef(boost::string_ref path, boost::string_ref objecttype2, RR_MOVE_ARG(boost::function<void(RR_SHARED_PTR<RRObject>, RR_SHARED_PTR<RobotRaconteurException>)>) handler, int32_t timeout)
	{
		...
		if (!GetConnected()) 
		{
			ROBOTRACONTEUR_LOG_DEBUG_COMPONENT_PATH(node, Client, GetLocalEndpoint(), path, "", "Service client not connected");
		...
		else
		{
			...
			e->ServicePath = path;
			RR_SHARED_PTR<detail::async_timeout_wrapper<RRObject> > t = RR_MAKE_SHARED<detail::async_timeout_wrapper<RRObject> >(GetNode(), boost::bind(&ClientContext::AsyncFindObjRef3, shared_from_this(), RR_BOOST_PLACEHOLDERS(_1), RR_BOOST_PLACEHOLDERS(_2), path.to_string(), handler));

			boost::function<void(RR_SHARED_PTR<RRObject>, RR_SHARED_PTR<RobotRaconteurException>)> h1(boost::bind(&detail::async_timeout_wrapper<RRObject>::operator(), t, RR_BOOST_PLACEHOLDERS(_1), RR_BOOST_PLACEHOLDERS(_2)));
			AsyncProcessRequest(e, boost::bind(&ClientContext::AsyncFindObjRef1, shared_from_this(), RR_BOOST_PLACEHOLDERS(_1), RR_BOOST_PLACEHOLDERS(_2), path.to_string(), objecttype2.to_string(), h1, timeout), timeout);
	...
	void ClientContext::AsyncFindObjRef1(RR_INTRUSIVE_PTR<MessageEntry> ret, RR_SHARED_PTR<RobotRaconteurException> err, const std::string& path, const std::string& objecttype2, boost::function<void(RR_SHARED_PTR<RRObject>, RR_SHARED_PTR<RobotRaconteurException>)>& handler, int32_t timeout)
	{
		...
		{
			ROBOTRACONTEUR_LOG_TRACE_COMPONENT_PATH(node, Client, GetLocalEndpoint(), path, "", "Received FindObjRef response");
			...
			try
			{
				...
				if (use_pulled_types)
				{
					...
					if (std::find(servicetypes.begin(), servicetypes.end(), objectdef) == servicetypes.end())
					{
						...
						AsyncPullServiceDefinitionAndImports(objectdef, boost::bind(&ClientContext::AsyncFindObjRef2, shared_from_this(), RR_BOOST_PLACEHOLDERS(_1), RR_BOOST_PLACEHOLDERS(_2), objecttype, objectdef.to_string(), path, objecttype2, handler, timeout), timeout);
						return;
					}

				}

				AsyncFindObjRef2(RR_SHARED_PTR<PullServiceDefinitionAndImportsReturn>(), RR_SHARED_PTR<RobotRaconteurException>(), objecttype, objectdef.to_string(), path, objecttype2, (handler), timeout);
			}			
		...
		else
		{
			...
			try
			{
				...
				if (use_pulled_types)
				{
					...
					ROBOTRACONTEUR_LOG_DEBUG_COMPONENT_PATH(node, Client, GetLocalEndpoint(), path, "", "FindObjRef returned type \"" << objecttype << "\" creating stub");
	...
	void ClientContext::AsyncFindObjectType(boost::string_ref path, RR_MOVE_ARG(boost::function<void(RR_SHARED_PTR<std::string>, RR_SHARED_PTR<RobotRaconteurException>)>) handler, int32_t timeout)
	{
		...
		//MessageElement m = e.AddElement("ObjectPath", path);
		e->ServicePath = path;
		AsyncProcessRequest(e, boost::bind(&ClientContext::AsyncFindObjectType1, shared_from_this(), RR_BOOST_PLACEHOLDERS(_1), RR_BOOST_PLACEHOLDERS(_2), path.to_string(), handler), timeout);
	}

	void ClientContext::AsyncFindObjectType1(RR_INTRUSIVE_PTR<MessageEntry> ret, RR_SHARED_PTR<RobotRaconteurException> err, const std::string& path, boost::function<void(RR_SHARED_PTR<std::string>, RR_SHARED_PTR<RobotRaconteurException>)>& handler)
	{
		if (err)
		{
			ROBOTRACONTEUR_LOG_DEBUG_COMPONENT_PATH(node, Client, GetLocalEndpoint(), path, "", "Error during FindObjectType: " << err->what());
			detail::InvokeHandlerWithException(node, handler, err);			
			return;
		}
		else
		{
			try
			{
				...
				try
				{
					ROBOTRACONTEUR_LOG_TRACE_COMPONENT_PATH(node, Client, GetLocalEndpoint(), path, "", "FindObjectType returned \"" << objecttype << "\"");
					RR_SHARED_PTR<std::string> ret = RR_MAKE_SHARED<std::string>(objecttype);
					detail::InvokeHandler(node, handler, ret);
				}
				catch (std::exception& exp)
				{
					ROBOTRACONTEUR_LOG_DEBUG_COMPONENT_PATH(node, Client, GetLocalEndpoint(), path, "", "Error during FindObjectType: " << exp.what());
	...
	void ClientContext::AsyncProcessRequest(RR_INTRUSIVE_PTR<MessageEntry> m, RR_MOVE_ARG(boost::function<void(RR_INTRUSIVE_PTR<MessageEntry>, RR_SHARED_PTR<RobotRaconteurException>)>) handler, int32_t timeout)
	{
...

		{
			...
			{
				RR_SHARED_PTR<Timer> timer = GetNode()->CreateTimer(boost::posix_time::milliseconds(timeout), boost::bind(&ClientContext::AsyncProcessRequest_timeout, shared_from_this(), RR_BOOST_PLACEHOLDERS(_1), myrequestid), true);
				timer->Start();
				t->timer = timer;
			}
		...
		ROBOTRACONTEUR_LOG_TRACE_COMPONENT_PATH(node, Client, GetLocalEndpoint(), m->ServicePath, m->MemberName, "AsyncProcessRequest sending message with requestid " << myrequestid << " EntryType " << m->EntryType);
		//Console.WriteLine("Sent " + m.RequestID + " " + m.EntryType + " " + m.MemberName);
		boost::function<void(RR_SHARED_PTR<RobotRaconteurException>)> h = boost::bind(&ClientContext::AsyncProcessRequest_err, shared_from_this(), RR_BOOST_PLACEHOLDERS(_1), myrequestid);
		AsyncSendMessage(m, h);

		}
		catch (std::exception& exp)
		{
			ROBOTRACONTEUR_LOG_DEBUG_COMPONENT_PATH(node, Client, GetLocalEndpoint(), m->ServicePath, m->MemberName, "Error during AsyncProcessRequest: " << exp.what());
			throw;
		}
	...
	void ClientContext::connection_test(const TimerEvent& ev)
	{
		...
		{
			typedef boost::tuple<uint32_t, boost::function<void(RR_INTRUSIVE_PTR<MessageEntry> ret, RR_SHARED_PTR<RobotRaconteurException> error)> > handler_type;
...

			{
				...
				BOOST_FOREACH(e_type& e, outstanding_requests)
				{
					...
					if (e.second->handler) handlers.push_back(boost::make_tuple(e.first,e.second->handler));
				}
			...
			{				
				ROBOTRACONTEUR_LOG_DEBUG_COMPONENT(node, Client, GetLocalEndpoint(), "Connection lost during AsyncProcessRequest with requestid " << e.get<0>());
	...
	void ClientContext::AsyncProcessRequest_err(RR_SHARED_PTR<RobotRaconteurException> error, uint32_t requestid)
	{
		...
		try
		{
			...
			ROBOTRACONTEUR_LOG_DEBUG_COMPONENT(node, Client, GetLocalEndpoint(), "Error during AsyncProcessRequest with requestid " << requestid << ": " << error->what());
		...
		{
			ROBOTRACONTEUR_LOG_DEBUG_COMPONENT(node, Client, GetLocalEndpoint(), "Failed to handle error during AsyncProcessRequest: " << exp.what());
			RobotRaconteurNode::TryHandleException(node, &exp);
		}
	}
	...
	void ClientContext::AsyncProcessRequest_timeout(const TimerEvent& error, uint32_t requestid)
	{
		if (!error.stopped)
		{
			...
			try
			{
				...
				ROBOTRACONTEUR_LOG_DEBUG_COMPONENT(node, Client, GetLocalEndpoint(), "AsyncProcessRequest with requestid " << requestid << " timed out");
	...
	void ClientContext::MessageReceived(RR_INTRUSIVE_PTR<Message> m)
	{
		...
		if (m->entries.size() >= 1)
		{
			...
			{
				ROBOTRACONTEUR_LOG_TRACE_COMPONENT(node, Client, GetLocalEndpoint(), "Client received connect client response RemoteNodeID: " 
					<< m->header->SenderNodeID.ToString() << " RemoteNodeName: " << m->header->SenderNodeName
		...
		BOOST_FOREACH(RR_INTRUSIVE_PTR<MessageEntry>& mm, m->entries)
		{
			...
			{
				ROBOTRACONTEUR_LOG_DEBUG_COMPONENT(node, Client, GetLocalEndpoint(), "Client received InvalidEndpoint error, assume session lost and close");
	...
	void DispatchEvent_func(RR_WEAK_PTR<RobotRaconteurNode> node, uint32_t ep, RR_SHARED_PTR<ServiceStub> stub, RR_INTRUSIVE_PTR<MessageEntry> m)
	{
		...
		{			
			ROBOTRACONTEUR_LOG_DEBUG_COMPONENT_PATH(node, Client, ep, m->ServicePath, m->MemberName, "DispatchEvent failed: " << exp.what());
			RobotRaconteurNode::TryHandleException(node,&exp);			
		}
	}
	...
	void ClientContext::MessageEntryReceived(RR_INTRUSIVE_PTR<MessageEntry> m)
	{
		...
		ROBOTRACONTEUR_LOG_TRACE_COMPONENT_PATH(node, Client, GetLocalEndpoint(), m->ServicePath, m->MemberName,
			"Client received message entry EntryType " << m->EntryType << " Error " << m->Error);

		{
			...
			if (m->EntryType == MessageEntryType_EventReq)
			{
				RR_SHARED_PTR<ServiceStub> stub;
				{
					RR_UNORDERED_MAP<MessageStringPtr, RR_SHARED_PTR<ServiceStub> >::iterator e1 = stubs.find(m->ServicePath.str());
					if (e1 == stubs.end()) return;
					stub = e1->second;
				}
				if (stub) 
				{
					RobotRaconteurNode::TryPostToThreadPool(node, boost::bind(&DispatchEvent_func, node, GetLocalEndpoint(), stub, m));
				}
				else
				{
					ROBOTRACONTEUR_LOG_TRACE_COMPONENT_PATH(node, Client, GetLocalEndpoint(), m->ServicePath, m->MemberName,
				...
				if (t)
				{
					try
					{
						if (t->handler)
						{
							...
							{
								ROBOTRACONTEUR_LOG_TRACE_COMPONENT_PATH(node, Client, GetLocalEndpoint(), m->ServicePath, m->MemberName, "AsyncProcessRequest with requestid " << requestid << " successful");
							...
							else if (m->Error == MessageErrorType_RemoteError)
							{
								...
								ROBOTRACONTEUR_LOG_DEBUG_COMPONENT_PATH(node, Client, GetLocalEndpoint(), m->ServicePath, m->MemberName, "Service returned remote error during ProcessRequest: " << err->what());
							...
							else
							{
								...
								{
									ROBOTRACONTEUR_LOG_DEBUG_COMPONENT_PATH(node, Client, GetLocalEndpoint(), m->ServicePath, m->MemberName, "Service returned error during ProcessRequest: " << m->Error);
								}
					...
					{
						ROBOTRACONTEUR_LOG_DEBUG_COMPONENT_PATH(node, Client, GetLocalEndpoint(), m->ServicePath, m->MemberName, "Error handling AsyncProcessRequest response: " << exp.what());
						RobotRaconteurNode::TryHandleException(node, &exp);
					}
				}
			...
			{
				ROBOTRACONTEUR_LOG_INFO_COMPONENT(node, Client, GetLocalEndpoint(), "Client received ServiceClosed, disconnecting");
			...
			else if (m->EntryType == MessageEntryType_PipePacket || m->EntryType == MessageEntryType_PipeClosed || m->EntryType == MessageEntryType_PipePacketRet)
			{
				...
				ROBOTRACONTEUR_LOG_TRACE_COMPONENT_PATH(node, Client, GetLocalEndpoint(), m->ServicePath, m->MemberName, "Received pipe packet entry type " << m->EntryType);
			...
			{
				ROBOTRACONTEUR_LOG_TRACE_COMPONENT_PATH(node, Client, GetLocalEndpoint(), m->ServicePath, m->MemberName, "Received wire packet entry type " << m->EntryType);
	...
	void ClientContext::AsyncConnectService(RR_SHARED_PTR<Transport> c, boost::string_ref url, boost::string_ref username, RR_INTRUSIVE_PTR<RRMap<std::string, RRValue> > credentials, boost::string_ref objecttype, RR_MOVE_ARG(boost::function<void(RR_SHARED_PTR<RRObject>, RR_SHARED_PTR<RobotRaconteurException>)>) handler, int32_t timeout)
	{		
		try
		{
		...
		{
			ROBOTRACONTEUR_LOG_DEBUG_COMPONENT(node, Client, GetLocalEndpoint(), "Invalid transport provided to AsyncConnectService");
			throw ServiceException("Invalid transport");
		}


		RR_SHARED_PTR<detail::async_timeout_wrapper<RRObject> > d = RR_MAKE_SHARED<detail::async_timeout_wrapper<RRObject> >(GetNode(), handler, boost::bind(&detail::async_timeout_wrapper_closer<RRObject, ClientContext>, RR_BOOST_PLACEHOLDERS(_1)));

		boost::function<void(RR_SHARED_PTR<RRObject>, RR_SHARED_PTR<RobotRaconteurException>) > h1(boost::bind(&detail::async_timeout_wrapper<RRObject>::operator(), d, RR_BOOST_PLACEHOLDERS(_1), RR_BOOST_PLACEHOLDERS(_2)));
		boost::function<void(RR_SHARED_PTR<ITransportConnection>, RR_SHARED_PTR<RobotRaconteurException>)> h(boost::bind(&ClientContext::AsyncConnectService1, shared_from_this(), c, RR_BOOST_PLACEHOLDERS(_1), RR_BOOST_PLACEHOLDERS(_2), url.to_string(), username.to_string(), credentials, objecttype.to_string(), h1));
		...
		{
			ROBOTRACONTEUR_LOG_DEBUG_COMPONENT(node, Client, GetLocalEndpoint(), "AsyncConnectService failed: " << exp.what());
			throw;
		}
	...
	void ClientContext::AsyncConnectService1(RR_SHARED_PTR<Transport> c, RR_SHARED_PTR<ITransportConnection> tc, RR_SHARED_PTR<RobotRaconteurException> e, const std::string& url, const std::string& username, RR_INTRUSIVE_PTR<RRMap<std::string, RRValue> > credentials, const std::string& objecttype, boost::function<void(RR_SHARED_PTR<RRObject>, RR_SHARED_PTR<RobotRaconteurException>)>& handler)
	{
		if (e)
		{
			ROBOTRACONTEUR_LOG_DEBUG_COMPONENT(node, Client, GetLocalEndpoint(), "AsyncConnectService failed: " << e->what());
	...
	void ClientContext::AsyncConnectService(RR_SHARED_PTR<Transport> c, RR_SHARED_PTR<ITransportConnection> tc, boost::string_ref url, boost::string_ref username, RR_INTRUSIVE_PTR<RRMap<std::string, RRValue> > credentials, boost::string_ref objecttype, RR_MOVE_ARG(boost::function<void(RR_SHARED_PTR<RRObject>, RR_SHARED_PTR<RobotRaconteurException>)>) handler, int32_t timeout)
	{
		...
		{
			ROBOTRACONTEUR_LOG_TRACE_COMPONENT(node, Client, GetLocalEndpoint(), "AsyncConnectService using ConnectClientCombined");
			...
			AsyncProcessRequest(m, boost::bind(&ClientContext::AsyncConnectService7, shared_from_this(), RR_BOOST_PLACEHOLDERS(_1), RR_BOOST_PLACEHOLDERS(_2), objecttype.to_string(), username.to_string(), handler), timeout);

			return;
		}

		ROBOTRACONTEUR_LOG_TRACE_COMPONENT(node, Client, GetLocalEndpoint(), "AsyncConnectService not using ConnectClientCombined");

		if (timeout == RR_TIMEOUT_INFINITE)
		{
			AsyncPullServiceDefinitionAndImports("", boost::bind(&ClientContext::AsyncConnectService2, shared_from_this(), RR_BOOST_PLACEHOLDERS(_1), RR_BOOST_PLACEHOLDERS(_2), username.to_string(), credentials, objecttype.to_string(), handler), GetNode()->GetRequestTimeout());
		}
		else
		{
			...
			RR_SHARED_PTR<detail::async_timeout_wrapper<RRObject> > d = RR_MAKE_SHARED<detail::async_timeout_wrapper<RRObject> >(GetNode(), handler, boost::bind(&detail::async_timeout_wrapper_closer<RRObject, ClientContext>, RR_BOOST_PLACEHOLDERS(_1)));
			boost::function<void(RR_SHARED_PTR<RRObject>, RR_SHARED_PTR<RobotRaconteurException>)> h1(boost::bind(&detail::async_timeout_wrapper<RRObject>::operator(), d, RR_BOOST_PLACEHOLDERS(_1), RR_BOOST_PLACEHOLDERS(_2)));
			AsyncPullServiceDefinitionAndImports("", boost::bind(&ClientContext::AsyncConnectService2, shared_from_this(), RR_BOOST_PLACEHOLDERS(_1), RR_BOOST_PLACEHOLDERS(_2), username.to_string(), credentials, objecttype.to_string(), h1), GetNode()->GetRequestTimeout());
			d->start_timer(timeout, RR_MAKE_SHARED<ConnectionException>("Timeout during operation"));
		}
		}
		catch (std::exception & exp)
	...
	void ClientContext::AsyncConnectService2(RR_SHARED_PTR<PullServiceDefinitionAndImportsReturn> d, RR_SHARED_PTR<RobotRaconteurException> e, const std::string& username, RR_INTRUSIVE_PTR<RRMap<std::string, RRValue> > credentials, const std::string& objecttype, boost::function<void(RR_SHARED_PTR<RRObject>, RR_SHARED_PTR<RobotRaconteurException>)>& handler)
	{
		...
		else
		{
			try
			{
				...
				ROBOTRACONTEUR_LOG_TRACE_COMPONENT(node, Client, GetLocalEndpoint(), "AsyncConnectService pulled service types");

				AsyncProcessRequest(e, boost::bind(&ClientContext::AsyncConnectService3, shared_from_this(), RR_BOOST_PLACEHOLDERS(_1), RR_BOOST_PLACEHOLDERS(_2), username, credentials, std::string(objecttype), d, handler), GetNode()->GetRequestTimeout());
			}
			catch (std::exception& err)
			{
				ROBOTRACONTEUR_LOG_DEBUG_COMPONENT(node, Client, GetLocalEndpoint(), "AsyncConnectService failed: " << err.what());
				detail::InvokeHandlerWithException(node, handler, err, MessageErrorType_ServiceError);
		...
		else
		{
			try
			{
				...
				/*if (!objecttype.empty() && type != objecttype)
				{
					...
					//AsyncPullServiceDefinitionAndImports(SplitQualifiedName(type).get<0>(), boost::bind(&ClientContext::AsyncConnectService4, shared_from_this(), RR_BOOST_PLACEHOLDERS(_1), RR_BOOST_PLACEHOLDERS(_2), username, credentials, objecttype, type, handler), GetNode()->GetRequestTimeout());
					//return;
				}*/

				ROBOTRACONTEUR_LOG_TRACE_COMPONENT(node, Client, GetLocalEndpoint(), "AsyncConnectService retrieved root object type: " << type);
			...
			try
			{
				if (GetNode()->GetDynamicServiceFactory())
				{
					...
					if (missingdefs.size() > 0)
					{
						...
						ROBOTRACONTEUR_LOG_DEBUG_COMPONENT(node, Client, GetLocalEndpoint(), "AsyncConnectService using dynamic service factory for types: " << boost::join(missingdefs_names,", "));
				...
				ROBOTRACONTEUR_LOG_TRACE_COMPONENT(node, Client, GetLocalEndpoint(), "AsyncConnectService retrieved additional service types");
				...
				AsyncProcessRequest(e2, boost::bind(&ClientContext::AsyncConnectService5, shared_from_this(), RR_BOOST_PLACEHOLDERS(_1), RR_BOOST_PLACEHOLDERS(_2), username, credentials, objecttype, type, d, handler), GetNode()->GetRequestTimeout());
			}			
			catch (std::exception& err)
			{
				ROBOTRACONTEUR_LOG_DEBUG_COMPONENT(node, Client, GetLocalEndpoint(), "AsyncConnectService failed: " << err.what());
	...
	void ClientContext::AsyncConnectService5(RR_INTRUSIVE_PTR<MessageEntry> ret, RR_SHARED_PTR<RobotRaconteurException> e, const std::string& username, RR_INTRUSIVE_PTR<RRMap<std::string, RRValue> > credentials, const std::string& objecttype, const std::string& type, RR_SHARED_PTR<PullServiceDefinitionAndImportsReturn> d, boost::function<void(RR_SHARED_PTR<RRObject>, RR_SHARED_PTR<RobotRaconteurException>)>& handler)
	{
		...
		else
		{
			try
			{
				...
				if (username != "")
				{
					ROBOTRACONTEUR_LOG_TRACE_COMPONENT(node, Client, GetLocalEndpoint(), "AsyncConnectService authenticating with username " << username);

					try
					{						
						//std::cout << "AsyncConnectService5_1" << std::endl;
						AsyncAuthenticateUser(username, credentials, boost::bind(&ClientContext::AsyncConnectService6, shared_from_this(), RR_BOOST_PLACEHOLDERS(_1), RR_BOOST_PLACEHOLDERS(_2), type, username, d, handler), GetNode()->GetRequestTimeout());
					}
				...
				{
					//std::cout << "AsyncConnectService5_1" << std::endl;
					AsyncConnectService6(RR_MAKE_SHARED<std::string>("OK"), RR_SHARED_PTR<RobotRaconteurException>(), type, username, d, (handler));
				}
	...
	void ClientContext::AsyncConnectService6(RR_SHARED_PTR<std::string> ret, RR_SHARED_PTR<RobotRaconteurException> e, const std::string& type, const std::string& username, RR_SHARED_PTR<PullServiceDefinitionAndImportsReturn> d, boost::function<void(RR_SHARED_PTR<RRObject>, RR_SHARED_PTR<RobotRaconteurException>)>& handler)
	{
		...
		{
			ROBOTRACONTEUR_LOG_DEBUG_COMPONENT(node, Client, GetLocalEndpoint(), "AsyncConnectService authentication failed");
		...
		else
		{
			try
			{
				...
				ROBOTRACONTEUR_LOG_DEBUG_COMPONENT(node, Client, GetLocalEndpoint(), "AsyncConnectService completed successfully");
			...
			{
				ROBOTRACONTEUR_LOG_DEBUG_COMPONENT(node, Client, GetLocalEndpoint(), "AsyncConnectService initializing client stub failed: " << err.what());
				detail::InvokeHandlerWithException(node, handler, err, MessageErrorType_ServiceError);
				AsyncClose(&ClientContext_empty_handler);
			}
		}
	...
	void ClientContext::AsyncConnectService7(RR_INTRUSIVE_PTR<MessageEntry> ret, RR_SHARED_PTR<RobotRaconteurException> e, const std::string& objecttype, const std::string& username, boost::function<void(RR_SHARED_PTR<RRObject>, RR_SHARED_PTR<RobotRaconteurException>)>& handler)
	{
	...
	/*bool ClientContext::VerifyObjectImplements2(boost::string_ref objecttype, boost::string_ref implementstype)
	{
		...
		std::map<std::string, RR_SHARED_PTR<ServiceDefinition> >::iterator e1 = pulled_service_defs.find(s1.get<0>().to_string());
	...
	void ClientContext::AsyncClose(RR_MOVE_ARG(boost::function<void()>) handler)
	{
		...
		try
		{
			...
			AsyncProcessRequest(e, boost::bind(&ClientContext::AsyncClose1, shared_from_this(), RR_BOOST_PLACEHOLDERS(_1), RR_BOOST_PLACEHOLDERS(_2), handler), 500);
		}
		catch (std::exception& err)
		{
	...
	void ClientContext::AsyncSendPipeMessage(RR_INTRUSIVE_PTR<MessageEntry> m, bool unreliable, boost::function<void(RR_SHARED_PTR<RobotRaconteurException>) >& handler)
	{
		if (!unreliable)
		{
			ROBOTRACONTEUR_LOG_TRACE_COMPONENT_PATH(node, Client, GetLocalEndpoint(), m->ServicePath, m->MemberName, "Client sending reliable pipe packet EntryType " << m->EntryType);
	...
	void ClientContext::AsyncPullServiceDefinition(boost::string_ref ServiceType, RR_MOVE_ARG(boost::function<void(RR_SHARED_PTR<PullServiceDefinitionReturn>, RR_SHARED_PTR<RobotRaconteurException>)>) handler, int32_t timeout)
	{
		...
		AsyncProcessRequest(e3, boost::bind(&ClientContext::AsyncPullServiceDefinition1, shared_from_this(), RR_BOOST_PLACEHOLDERS(_1), RR_BOOST_PLACEHOLDERS(_2), ServiceType.to_string(),handler), timeout);
	}
	...
	void ClientContext::AsyncPullServiceDefinition1(RR_INTRUSIVE_PTR<MessageEntry> ret3, RR_SHARED_PTR<RobotRaconteurException> err, const std::string& ServiceType, boost::function<void(RR_SHARED_PTR<PullServiceDefinitionReturn>, RR_SHARED_PTR<RobotRaconteurException>) > & handler)
	{
		if (err)
		{
			ROBOTRACONTEUR_LOG_DEBUG_COMPONENT(node, Client, GetLocalEndpoint(), "AsyncPullServiceDefinition failed: " << err->what());
			detail::InvokeHandlerWithException(node, handler, err);
			return;
		}
		else
		{
			...
			try
			{
				...
				ROBOTRACONTEUR_LOG_TRACE_COMPONENT(node, Client, GetLocalEndpoint(), "AsyncPullServiceDefinition completed successfully");
	...
	void ClientContext::AsyncPullServiceDefinitionAndImports1(RR_SHARED_PTR<PullServiceDefinitionReturn> pull_ret, RR_SHARED_PTR<RobotRaconteurException> err, const std::string& servicetype, RR_SHARED_PTR<PullServiceDefinitionAndImportsReturn> current, boost::function<void(RR_SHARED_PTR<PullServiceDefinitionAndImportsReturn>, RR_SHARED_PTR<RobotRaconteurException>)>& handler, boost::posix_time::ptime timeout_time)
	{
		...
		else
		{
			try
			{
				...
				{
					ROBOTRACONTEUR_LOG_TRACE_COMPONENT(node, Client, GetLocalEndpoint(), "AsyncPullServiceDefinitionAndImports completed successfully");
			...
			{
				ROBOTRACONTEUR_LOG_DEBUG_COMPONENT(node, Client, GetLocalEndpoint(), "Begin AsyncPullServiceDefinition failed: " << err.what());
				detail::InvokeHandlerWithException(node, handler, err, MessageErrorType_ConnectionError);				
			}
		}
	}
	...
	{
		RR_UNORDERED_MAP<std::string, RR_SHARED_PTR<ServiceFactory> >::iterator e1 = pulled_service_types.find(type.to_string());
	...
	void ClientContext::AsyncAuthenticateUser(boost::string_ref username, RR_INTRUSIVE_PTR<RRValue> credentials, RR_MOVE_ARG(boost::function<void(RR_SHARED_PTR<std::string>, RR_SHARED_PTR<RobotRaconteurException>)>) handler, int32_t timeout)
	{

		ROBOTRACONTEUR_LOG_TRACE_COMPONENT(node, Client, GetLocalEndpoint(), "Begin AuthenticateUser with username \"" << username << "\"");
		try
		{
			...
			AsyncProcessRequest(m, boost::bind(&ClientContext::AsyncAuthenticateUser2, shared_from_this(), RR_BOOST_PLACEHOLDERS(_1), RR_BOOST_PLACEHOLDERS(_2), username.to_string(), handler), timeout);
		}
		catch (std::exception& exp)
		{
	...
	void ClientContext::AsyncAuthenticateUser2(RR_INTRUSIVE_PTR<MessageEntry> ret, RR_SHARED_PTR<RobotRaconteurException> err, const std::string& username, boost::function<void(RR_SHARED_PTR<std::string>, RR_SHARED_PTR<RobotRaconteurException>)>& handler)
	{
		if (err)
		{
			ROBOTRACONTEUR_LOG_DEBUG_COMPONENT(node, Client, GetLocalEndpoint(), "AuthenticateUser failed: " << err->what());
			detail::InvokeHandlerWithException(node, handler, err);
			return;
		}
		...
		ROBOTRACONTEUR_LOG_TRACE_COMPONENT(node, Client, GetLocalEndpoint(), "AuthenticateUser completed successfully with username \"" << username << "\"");
	...
	void ClientContext::AsyncRequestObjectLock(RR_SHARED_PTR<RRObject> obj, RobotRaconteurObjectLockFlags flags, RR_MOVE_ARG(boost::function<void(RR_SHARED_PTR<std::string>, RR_SHARED_PTR<RobotRaconteurException>)>) handler, int32_t timeout)
	{
		try
		{
			...
			ROBOTRACONTEUR_LOG_TRACE_COMPONENT(node, Client, GetLocalEndpoint(), "Begin AsyncRequestObjectLock for servicepath \"" << s->ServicePath << "\" with command " << command);
			...
			AsyncProcessRequest(m, boost::bind(&ClientContext::EndAsyncLockOp, shared_from_this(), RR_BOOST_PLACEHOLDERS(_1), RR_BOOST_PLACEHOLDERS(_2), handler), timeout);
		}
	...
	void ClientContext::AsyncReleaseObjectLock(RR_SHARED_PTR<RRObject> obj, RR_MOVE_ARG(boost::function<void(RR_SHARED_PTR<std::string>, RR_SHARED_PTR<RobotRaconteurException>)>) handler, int32_t timeout)
	{
		try
		{
			...
			ROBOTRACONTEUR_LOG_TRACE_COMPONENT(node, Client, GetLocalEndpoint(), "Begin AsyncReleaseObjectLock for servicepath \"" << s->ServicePath << "\"");
	...
	void ClientContext::ProcessCallbackCall(RR_INTRUSIVE_PTR<MessageEntry> m)
	{
		...
		ROBOTRACONTEUR_LOG_TRACE_COMPONENT_PATH(node, Client, GetLocalEndpoint(), m->ServicePath, m->MemberName, "Received callback call request with requestid " << m->RequestID);
		...
		{
			ROBOTRACONTEUR_LOG_DEBUG_COMPONENT_PATH(node, Client, GetLocalEndpoint(), m->ServicePath, m->MemberName, "Client callback returning caught exception to caller: " << e.what());
		...
		ROBOTRACONTEUR_LOG_TRACE_COMPONENT_PATH(node, Client, GetLocalEndpoint(), m->ServicePath, m->MemberName, "Client callback completed successfully");
