...
namespace RobotRaconteur
{
    ...
    const std::string& source_file, uint32_t source_line)
    {
        ...
        return new RRLogRecordStream(node1, lvl, component, component_name, component_object_id, ep, service_path.str().to_string(), member_name.str().to_string(), boost::posix_time::microsec_clock::local_time(), source_file, source_line, "","");
    }
